    ...
    <div class="group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Basic Elements</h5>
                </div>
            ...
            <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            <label for="inputPlainReadOnly" class="inline-block mb-2 text-base font-medium">Readonly Plain
                                Text Input</label>
                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            <label for="inputPlainReadOnly" class="inline-block mb-2 text-base font-medium">Readonly
                                Input</label>
                            <input type="text" id="inputPlainReadOnly"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                value="Readonly input" readonly="">
                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            <label for="inputPlainReadOnly" class="inline-block mb-2 text-base font-medium">Disabled
                                Input</label>
                            <input type="text" id="inputPlainReadOnly"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            <label for="inputWithIcon" class="inline-block mb-2 text-base font-medium">Input with
                                Icon</label>
                            <div class="relative">
                                <i data-lucide="mail"
                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            <label for="inputRoundedInput" class="inline-block mb-2 text-base font-medium">Rounded
                                Input</label>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="grid items-center grid-cols-1 gap-5 xl:grid-cols-3">
                        <div>
                            <label for="DefaultRange" class="inline-block mb-2 text-base font-medium">Default
                                Range</label>

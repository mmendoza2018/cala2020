                        ...
                        <template id="templateFeatures">
                            <tr>
                                <td class="px-3.5 py-2.5 border-y border-custom-200 dark:border-custom-900">
                                    <x-select name="measurement_unit_id" id="selectIcons" class="choices m-0 p-0"

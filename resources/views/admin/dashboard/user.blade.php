...
@section('content')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-x-5 mt-5">
                ...
                <div class="card p-3">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="" id="totalWebUsers"></span>
                        </h5>
                        <p class="text-slate-500 dark:text-zink-200">Usuarios registrados</p>
                    </div>
                </div><!--end col-->

            </div>

            <div class="w-full card mt-5 p-2">
                <div id="departmentsChart"></div>
            </div>

            <div class="w-full card mt-5 p-3">
                <table id="tableSaleByUser" class="w-full">
                    <thead>
                        <tr>
                            <th>Nombres</th>
                            <th>Correo</th>
...
@section('script')
    ...
    <script src="{{ URL::to('assets/js/custom/dashboard_user.js') }}"></script>
@endsection

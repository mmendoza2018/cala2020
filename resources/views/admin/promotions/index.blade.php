    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Promociones</h5>
                </div>
                        ...
                        <div id="modalAddBanner" modal-center=""
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <button data-modal-close="modalAddBanner"
                                    ...
                                    <tr data-table={{ $promotion->id }}>
                                        ...
                                        <td class="text-center">
                                            <i class="ri-edit-box-fill ri-xl cursor-pointer"
                                                onclick="getBanner('{{ $promotion->id }}')"></i>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <script type="text/template" id="preview-template">
        <div class="dz-preview dz-file-preview" style="width: 100%">
            <div class="" style="width: 100%">
                <img data-dz-thumbnail style="aspect-ratio: 16 / 9; object-fit: cover !important; width: 100%; height: auto;" />
            </div>
...
@section('script')
    ...
    <script src="{{ URL::to('assets/js/custom/promotions.js') }}"></script>
@endsection

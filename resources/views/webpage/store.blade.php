                ...
                <div class="card">
                    <div class="card-body">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="shrink-0">
                                <a href="#!"
                                    class="underline transition-all duration-200 ease-linear hover:text-custom-500">Clear All</a>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 collapsible">
                            ...
                            <div class="mt-4 collapsible-content">
                                <div class="flex flex-wrap items-center gap-2">
                                    <input id="color1"
                                        class="border rounded-sm appearance-none cursor-pointer size-5 border-custom-500 bg-custom-500 checked:bg-custom-500 checked:border-custom-500"
                                        type="checkbox" value="">
                                    <input id="color2"
                                        class="bg-red-300 border border-red-300 rounded-sm appearance-none cursor-pointer size-5 checked:bg-red-300 checked:border-red-300"
                                        type="checkbox" value="">
                                    <input id="color3"
                                        class="bg-green-300 border border-green-300 rounded-sm appearance-none cursor-pointer size-5 checked:bg-green-300 checked:border-green-300"
                                        type="checkbox" value="">
                                    <input id="color4"
                                        class="border rounded-sm appearance-none cursor-pointer size-5 border-slate-500 bg-slate-500 checked:bg-slate-500 checked:border-slate-500"
                                        type="checkbox" value="">
                                    <input id="color5"
                                        class="bg-purple-500 border border-purple-500 rounded-sm appearance-none cursor-pointer size-5 checked:bg-purple-500 checked:border-purple-500"
                                        type="checkbox" value="">
                                    <input id="color6"
                                        class="border rounded-sm appearance-none cursor-pointer size-5 bg-sky-500 border-sky-500 checked:bg-sky-500 checked:border-sky-500"
                                        type="checkbox" value="">
                                    <input id="color7"
                                        class="bg-yellow-500 border border-yellow-500 rounded-sm appearance-none cursor-pointer size-5 checked:bg-yellow-500 checked:border-yellow-500"
                                        type="checkbox" value="">
                                    <input id="color7"
                                        class="bg-green-500 border border-green-500 rounded-sm appearance-none cursor-pointer size-5 checked:bg-green-500 checked:border-green-500"
                                        type="checkbox" value="">
                                    <input id="color8"
                                        class="border rounded-sm appearance-none cursor-pointer size-5 bg-slate-800 border-slate-800 checked:bg-slate-800 checked:border-slate-800"
                                        type="checkbox" value="">
                                    <input id="color9"
                                        class="border rounded-sm appearance-none cursor-pointer size-5 bg-slate-200 border-slate-200 checked:bg-slate-200 checked:border-slate-200"
                                        type="checkbox" value="">
                                    <input id="color10"
                                        class="border rounded-sm appearance-none cursor-pointer size-5 bg-emerald-300 border-embg-emerald-300 checked:bg-emerald-300 checked:border-embg-emerald-300"
                                        type="checkbox" value="">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <label for="rating5" class="align-middle cursor-pointer">
                                            <i data-lucide="star"
                                                class="inline-block ml-1 text-yellow-500 align-middle size-4"></i> <span
                        ...
                        <div
                            ...
                            <div class="group-[.gridView]:grow">
                                <h6
                                    ...
                                    <a href="apps-ecommerce-product-overview.html">Mesh Ergonomic Black Chair</a></h6>
                    ...
                    <div class="card md:group-[.gridView]:flex relative">
                        ...
                        <div
                            ...
                            <div class="group-[.gridView]:grow">
                                <h6
                                    class="mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500">
                                    <a href="apps-ecommerce-product-overview.html">Fastcolors Typography Men</a></h6>
                    ...
                    <div class="card md:group-[.gridView]:flex relative">
                        ...
                        <div
                            ...
                            <div class="group-[.gridView]:grow">
                                <h6
                                    class="mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500">
                                    <a href="apps-ecommerce-product-overview.html">Mesh Ergonomic Green Chair</a></h6>
                    ...
                    <div class="card md:group-[.gridView]:flex relative">
                        ...
                        <div
                            ...
                            <div class="group-[.gridView]:grow">
                                <h6
                                    class="mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500">
                                    <a href="apps-ecommerce-product-overview.html">Techel Black Bluetooth Soundbar</a></h6>
                    ...
                    <div class="card md:group-[.gridView]:flex relative">
                        ...
                        <div
                            ...
                            <div class="group-[.gridView]:grow">
                                <h6
                                    class="mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500">
                                    <a href="apps-ecommerce-product-overview.html">Bovet Fleurier AIFSQ029</a></h6>
                    ...
                    <div class="card md:group-[.gridView]:flex relative">
                        ...
                        <div
                            ...
                            <div class="group-[.gridView]:grow">
                                <h6
                                    class="mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500">
                                    <a href="apps-ecommerce-product-overview.html">Roar Twill Blue Baseball Cap</a></h6>
                    ...
                    <div class="card md:group-[.gridView]:flex relative">
                        ...
                        <div
                            ...
                            <div class="group-[.gridView]:grow">
                                <h6
                                    class="mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500">
                                    <a href="apps-ecommerce-product-overview.html">Smartest Printed T-shirt</a></h6>
                    ...
                    <div class="card md:group-[.gridView]:flex relative">
                        ...
                        <div
                            ...
                            <div class="group-[.gridView]:grow">
                                <h6
                                    class="mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500">
                                    <a href="apps-ecommerce-product-overview.html">Crop tops for Women western wear</a></h6>
